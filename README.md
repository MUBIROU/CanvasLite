...
* [Flash](https://ja.wikipedia.org/wiki/Adobe_Flash) の代替技術として作成した HTML Canvas 2D 制御用 JavaScript（[ECMAScript 6](https://github.com/mubirou/HelloWorld/blob/master/languages/ECMAScript6/ECMAScript6_reference.md)+）自作フレームワーク

...
class ScoreLine { //五線譜の生成
    ...
    __inLoop(_this) {
        ...
        if (_this.__scoreCircle5.__count < 0.5) {
            if (_this.__scoreCircle1.alpha < 0.5) _this.__scoreCircle1.alpha = _this.__scoreCircle1.__count;
            if (_this.__scoreCircle2.alpha < 0.5) _this.__scoreCircle2.alpha = _this.__scoreCircle2.__count;
            if (_this.__scoreCircle3.alpha < 0.5) _this.__scoreCircle3.alpha = _this.__scoreCircle3.__count;
            if (_this.__scoreCircle4.alpha < 0.5) _this.__scoreCircle4.alpha = _this.__scoreCircle4.__count;
            if (_this.__scoreCircle5.alpha < 0.5) _this.__scoreCircle5.alpha = _this.__scoreCircle5.__count;
        } else {
            _this.__scoreCircle1.alpha = 0.5;
            _this.__scoreCircle2.alpha = 0.5;
            _this.__scoreCircle3.alpha = 0.5;
            _this.__scoreCircle4.alpha = 0.5;
            _this.__scoreCircle5.alpha = 0.5;
